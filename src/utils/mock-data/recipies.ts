...
"Add the wine and lemon juice, and cook for another 2-3 minutes, until the sauce has thickened.",
"Season with salt and black pepper, to taste.",
"Serve the shrimp over the cooked pasta, garnished with fresh parsley."
]
},
{
  id: 5,
  ...
  directions: [
    "In a small bowl, whisk together the soy sauce, brown sugar, cornstarch, ginger, and red pepper flakes.",
    "In a large skillet, heat the oil over high heat.",
    "Add the beef and stir-fry for 2-3 minutes, until browned.",
    "Add the garlic and broccoli, and stir-fry for another 2-3 minutes.",
    "Add the sauce to the skillet and cook for 1-2 minutes, until thickened.",
